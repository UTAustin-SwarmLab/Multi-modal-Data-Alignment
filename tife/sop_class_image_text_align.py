...
def SOP_class_align(cfg: DictConfig):
    ...
    plot_several_pdf(data_vector_list=[sim_align, sim_unalign], 
                     ...
                     ax=ax)
    if cfg.equal_weights:
        save_fig(fig, plots_folder_path + f'similarity_score_class_dim{cfg.sim_dim}_{cfg.train_test_ratio}.png')
    else:
        save_fig(fig, plots_folder_path + f'similarity_score_class_dim{cfg.sim_dim}_{cfg.train_test_ratio}_noweight.png')
    ...
    # ax.set_xlim(0, 1)
    # ax.set_ylim(0, 1)
    # fig.savefig(plots_folder_path + f'ROC_class_dim{cfg.sim_dim}_{cfg.train_test_ratio}.png')
