...
def main(cfg: DictConfig):  # noqa: D103
    ...
    print(
        "Stats of trainFeatImg2:", trainFeatImg2.max(), trainFeatImg2.min(), trainFeatImg2.mean(), trainFeatImg2.std()
    )
    ...
    print(
        "Stats of trainFeatImg after adding noise:",
        trainFeatImg.max(),
        trainFeatImg.min(),
        trainFeatImg.mean(),
        trainFeatImg.std(),
    ...
    print(
        "Stats of trainFeatImg2 after adding noise:",
        trainFeatImg2.max(),
        trainFeatImg2.min(),
        trainFeatImg2.mean(),
        trainFeatImg2.std(),
    ...
    assert np.allclose(
        trainFeatImg2.mean(axis=0), 0, atol=1e-4
    ), f"trainFeatImg2 not zero mean: {trainFeatImg2.mean(axis=0)}"
    ...
    for dim in range(600, 701, 200):
        ...
        trainAcc = svm.get_accuracy(svm.y_pred, gt_train)
        valAcc = svm.get_accuracy(valPred, gt_val)
        print(f"PCA train img 1 SVM Accuracy {trainAcc:.4f} | val SVM Accuracy {valAcc:.4f}")
        ...
        trainAcc = svm.get_accuracy(svm.y_pred, gt_train)
        valAcc = svm.get_accuracy(valPred, gt_val)
        print(f"PCA train img 2 SVM Accuracy {trainAcc:.4f} | val SVM Accuracy {valAcc:.4f}")
        ...
        trainAcc = svm.get_accuracy(svm.y_pred, gt_train)
        valAcc = svm.get_accuracy(valPred, gt_val)
        print(f"PCA train 2imgs SVM Accuracy {trainAcc:.4f} | val SVM Accuracy {valAcc:.4f}")
        ...
        trainAcc = svm.get_accuracy(svm.y_pred, gt_train)
        valAcc = svm.get_accuracy(valPred, gt_val)
        print(f"CCA train img 1 SVM Accuracy {trainAcc:.4f} | val SVM Accuracy {valAcc:.4f}")
        ...
        trainAcc = svm.get_accuracy(svm.y_pred, gt_train)
        valAcc = svm.get_accuracy(valPred, gt_val)
        print(f"CCA train img 2 SVM Accuracy {trainAcc:.4f} | val SVM Accuracy {valAcc:.4f}")
        ...
        trainAcc = svm.get_accuracy(svm.y_pred, gt_train)
        valAcc = svm.get_accuracy(valPred, gt_val)
        print(f"CCA train 2imgs SVM Accuracy {trainAcc:.4f} | val SVM Accuracy {valAcc:.4f}")
