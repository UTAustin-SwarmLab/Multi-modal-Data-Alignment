...
import numpy as np
import torch
from mmda.liploc.utils.model_utils import get_filenames, get_transforms
...
class CILPDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image1_neg = cv2.imread(
            f"{self.data_path}/{seq_neg}/image_2/{instance_neg}.png"
        )
        lidar_points_neg = loadCloudFromBinary(
            f"{self.data_path}/{seq_neg}/velodyne/{instance_neg}.bin"
        )
